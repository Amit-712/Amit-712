In this analysis, we performed an exploratory data analysis (EDA) on the Black Friday dataset to uncover insights into customer demographics and purchasing behavior. The main steps and findings include:
